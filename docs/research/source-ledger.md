...
| Supermemory TypeScript SDK | https://github.com/supermemoryai/sdk-ts / https://www.npmjs.com/package/supermemory | Apache-2.0 | Public TypeScript SDK surface for optional external memory integration. No SDK code copied; CodeDecay uses an optional dynamic import boundary. | yes |
