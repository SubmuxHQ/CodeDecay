...
export function createPortableAgentPrompt(summary: AgentTaskSummary, profile: AgentProfile): string {
  return [
    ...
    "3. Use changed-path proof entries to add or improve tests that execute the real route/API or behavior path instead of only importing, mocking, or copying implementation logic.",
