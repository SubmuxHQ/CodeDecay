...
function getKnownOptionFlags(command: string, docs: Record<string, CommandDoc>): string[] {
...
function resolveHelpTopic(topic: string, docs: Record<string, CommandDoc>): CommandDoc {
