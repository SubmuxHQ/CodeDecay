...
export interface ResilienceSafetyToolInput {
...
export async function runResilienceSafetyTool(
  options: StartMcpServerOptions,
  input: ResilienceSafetyToolInput
): Promise<string> {
  ...
  return renderResilienceSafetyMarkdown(report);
}
