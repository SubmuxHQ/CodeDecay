...
import { runPolicyDecisionTool } from "./handlers/policy-decision";
...
export { runPolicyDecisionTool } from "./handlers/policy-decision";
export {
  runProductFailuresTool,
  runProductPlanTool,
  runProductRerunTool,
...
export function createCodeDecayMcpServer(options: StartMcpServerOptions): McpServer {
  ...
  registerCodeDecayMcpTools(server, {
    ...
    policyDecision: (input) => runPolicyDecisionTool(options, input),
